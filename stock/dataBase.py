...
def build():
    ...
    try:
        ...
        cur.execute("CREATE TABLE financialsheet (row_Id BIGINT(10) NOT NULL AUTO_INCREMENT,company_Family VARCHAR(200),company_Id VARCHAR(200) NOT NULL,accounting VARCHAR(600),amount DECIMAL(15,2),unit VARCHAR(10),period VARCHAR(20),created TIMESTAMP DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY (row_Id,company_Id))")
        print("数据库建立完毕")
